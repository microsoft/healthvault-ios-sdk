...
//    if (self)
//    {
//        _inner = [[NSMutableArray alloc] initWithArray:things];
//    }
//    
//    return self;
//}
...
//        
//        MHVThing *thing = (MHVThing *)obj;
//        [index setObject:thing forKey:thing.key.thingID];
//    }
//    
//    return index;
//}
...
//        
//        MHVThing *thing = (MHVThing *)obj;
//        if ([thing.type.typeID isEqualToString:typeID])
//        {
//            return i;
//        }
//    }
...
//}
//
//- (NSArray<NSString *> *)thingIDs
//{
//    NSArray<NSString *> *collection = [NSArray<NSString *> new];
//    
...
//    for (NSUInteger i = 0; i < self.count; ++i)
//    {
//        MHVThing *clone = [[self objectAtIndex:i] shallowClone];
//        
//        if (!clone)
//        {
//            return NO;
...
//- (void)serialize:(XWriter *)writer
//{
//    [writer writeElementArray:c_element_thing elements:self.toArray];
//}
//
//- (void)deserialize:(XReader *)reader
//{
//    _inner = [reader readElementArray:c_element_thing asClass:[MHVThing class]];
//}
//
//@end
