...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"adherenceDelta": @"adherenceDelta", @"localDateTime": @"localDateTime", @"type": @"type", @"recurrenceType": @"recurrenceType", @"occurrences": @"occurrences" }];
}
 */
