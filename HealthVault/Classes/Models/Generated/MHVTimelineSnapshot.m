...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"schedules": @"schedules", @"completionMetrics": @"completionMetrics", @"unscheduledOccurrences": @"unscheduledOccurrences", @"effectiveStartInstant": @"effectiveStartInstant", @"effectiveEndInstant": @"effectiveEndInstant" }];
}
 */
