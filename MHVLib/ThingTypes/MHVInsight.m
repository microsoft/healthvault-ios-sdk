...
- (void)serialize:(XWriter *)writer
{
    ...
    [writer writeElementArray:c_element_data_used_pivot elements:self.dataUsedPivot.toArray];
    ...
    [writer writeElementArray:c_element_tags elements:self.tags.toArray];
    [writer writeElementArray:c_element_values elements:self.values.toArray];
    [writer writeElementArray:c_element_links elements:self.links.toArray];
...
- (void)deserialize:(XReader *)reader
{
    ...
    self.tags = (MHVString1024NWCollection *)[reader readElementArray:c_element_tags asClass:[MHVString1024NW class] andArrayClass:[MHVString1024NWCollection class]];
    self.values = (MHVStructuredInsightValueCollection *)[reader readElementArray:c_element_values asClass:[MHVStructuredInsightValue class] andArrayClass:[MHVStructuredInsightValueCollection class]];
    self.links = (MHVStructuredInsightValueCollection *)[reader readElementArray:c_element_links asClass:[MHVStructuredInsightValue class] andArrayClass:[MHVStructuredInsightValueCollection class]];
