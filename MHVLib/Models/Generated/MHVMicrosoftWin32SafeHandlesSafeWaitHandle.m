...
@implementation MHVMicrosoftWin32SafeHandlesSafeWaitHandle
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"isInvalid": @"isInvalid", @"isClosed": @"isClosed" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"isInvalid", @"isClosed"];
