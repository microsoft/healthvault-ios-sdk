...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"actionPlanTask": @"actionPlanTask", @"xmlThingDocument": @"xmlThingDocument" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"actionPlanTask", @"xmlThingDocument"];
