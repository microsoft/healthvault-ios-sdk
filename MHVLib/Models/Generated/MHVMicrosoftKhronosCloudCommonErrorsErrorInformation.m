...
@implementation MHVMicrosoftKhronosCloudCommonErrorsErrorInformation
...
+ (NSDictionary *)objectParametersMap
{
    ...
    dispatch_once(&once, ^{
        ...
        [types addEntriesFromDictionary:@{
              ...
              @"details": [MHVMicrosoftKhronosCloudCommonErrorsErrorInformation class],

              @"innererror": [MHVMicrosoftKhronosCloudCommonErrorsErrorInformation class],

              @"exception": [MHVSystemObject class]
        }];
    });
    return types;
}
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"code", @"message", @"target", @"details", @"innererror", @"exception"];
