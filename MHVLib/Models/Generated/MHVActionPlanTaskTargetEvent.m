...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"elementXPath": @"elementXPath", @"elementValues": @"elementValues", @"isNegated": @"isNegated" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"elementXPath", @"elementValues", @"isNegated"];
