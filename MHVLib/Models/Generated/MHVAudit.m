...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"timestamp": @"timestamp", @"personId": @"personId", @"applicationId": @"applicationId", @"auditAction": @"auditAction" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"timestamp", @"personId", @"applicationId", @"auditAction"];
