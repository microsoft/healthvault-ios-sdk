...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"_id": @"id", @"name": @"name", @"outcomeName": @"outcomeName", @"associatedTasks": @"associatedTasks" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"name", @"outcomeName", @"associatedTasks"];
