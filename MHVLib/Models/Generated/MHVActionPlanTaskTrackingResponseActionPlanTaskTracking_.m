...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"taskTrackingInstances": @"taskTrackingInstances", @"nextLink": @"nextLink" }];
}
 */
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"taskTrackingInstances", @"nextLink"];
