...
- (void)serialize:(XWriter *)writer
{
    ...
    [writer writeElementArray:c_element_series elements:self.series.toArray];
    ...
    [writer writeElementArray:c_element_key_images elements:self.keyImages.toArray];
...
- (void)deserialize:(XReader *)reader
{
    ...
    self.series = (MHVMedicalImageStudySeriesCollection *)[reader readElementArray:c_element_series asClass:[MHVMedicalImageStudySeries class] andArrayClass:[MHVMedicalImageStudySeriesCollection class]];
    ...
    self.keyImages = (MHVMedicalImageStudySeriesImageCollection *)[reader readElementArray:c_element_key_images asClass:[MHVMedicalImageStudySeriesImage class] andArrayClass:[MHVMedicalImageStudySeriesImageCollection class]];
