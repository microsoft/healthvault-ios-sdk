...
{
@private
    MHVPerson* m_prescriber;
    MHVApproxDateTime* m_datePrescribed;
    MHVApproxMeasurement* m_amount;
    MHVCodableValue* m_substitution;
    MHVNonNegativeInt* m_refills;
    MHVPositiveInt* m_daysSupply;
    MHVDate* m_expiration;
    MHVCodableValue* m_instructions;
}
//
// Required
//
