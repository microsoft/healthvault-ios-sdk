...
@interface MHVItemCommitErrorHandler : NSObject
{
@private
...
-(BOOL) shouldRetryChange:(MHVItemChange *) change onException:(id) ex;
-(BOOL) shouldCreateNewItemForConflict:(MHVItemChange *) change onException:(id) ex;
