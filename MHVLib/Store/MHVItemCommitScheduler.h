...
// You create an MHVItemCommitScheduler and give it an optional frequency at which it should run.
...
//
//--------------------------------------------------------------
@interface MHVItemCommitScheduler : NSObject
{
@private
