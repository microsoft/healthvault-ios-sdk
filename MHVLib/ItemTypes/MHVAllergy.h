...
@private
    ...
    MHVCodableValue* m_reaction;
    MHVApproxDateTime* m_firstObserved;
    MHVCodableValue* m_allergenType;
    MHVCodableValue* m_allergenCode;
    MHVPerson* m_treatmentProvider;
    MHVCodableValue* m_treatment;
    MHVBool* m_isNegated;
}
