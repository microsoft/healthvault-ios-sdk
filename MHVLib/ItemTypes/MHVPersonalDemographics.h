...
@private
    MHVName* m_name;
    MHVDateTime* m_birthdate;
    MHVCodableValue* m_bloodType;
    MHVCodableValue* m_ethnicity;
    NSString* m_ssn;
    MHVCodableValue* m_maritalStatus;
    NSString* m_employmentStatus;
    MHVBool* m_isDeceased;
    MHVApproxDateTime* m_dateOfDeath;
    MHVCodableValue* m_religion;
    MHVBool* m_veteran;
    MHVCodableValue* m_education;
    MHVBool* m_disabled;
    NSString* m_donor;
}
