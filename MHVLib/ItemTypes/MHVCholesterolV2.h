...
@interface MHVCholesterolV2 : MHVItemDataTyped
{
@private
    MHVDateTime* m_when;
    MHVConcentrationValue* m_ldl;
    MHVConcentrationValue* m_hdl;
    MHVConcentrationValue* m_total;
    MHVConcentrationValue* m_triglycerides;
}
