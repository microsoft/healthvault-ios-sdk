...
{
    HVENSURE(m_ldl, MHVConcentrationValue);
...
{
    HVENSURE(m_hdl, MHVConcentrationValue);
...
{
    HVENSURE(m_triglycerides, MHVConcentrationValue);
...
{
    HVENSURE(m_total, MHVConcentrationValue);
