...
NSString *const MHVDeserializationErrorDomainKey = @"MHVDeserializationErrorDomainKey";

NSInteger const MHVTypeMismatchErrorCode = 143553;

NSInteger const MHVEmptyValueOccurredErrorCode = 143509;

NSInteger const MHVUnknownResponseObjectErrorCode = 143528;


@interface MHVResponseDeserializer ()
...
@implementation MHVResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:MHVDeserializationErrorDomainKey code:MHVTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:MHVDeserializationErrorDomainKey code:MHVEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:MHVDeserializationErrorDomainKey code:MHVUnknownResponseObjectErrorCode userInfo:userInfo];
}
