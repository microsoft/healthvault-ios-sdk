...
#import "MHVBasicAuthTokenProvider.h"
#import "MHVLogger.h"

@interface MHVDefaultConfiguration ()
...
@implementation MHVDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static MHVDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://hvc-dev-khvwus01.westus2.cloudapp.azure.com";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [MHVLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [MHVBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
