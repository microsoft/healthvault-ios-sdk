...
extern NSString * MHVPercentEscapedStringFromString(NSString *string);

extern NSString * const kMHVApplicationJSONType;

@protocol MHVSanitizer <NSObject>
...
@interface MHVSanitizer : NSObject <MHVSanitizer>
