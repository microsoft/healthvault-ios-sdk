...
#import "HVImmunizationFactory.h"

@implementation HVImmunization (HVFactoryMethods)
...
{
    return [HVImmunization createRandomForDay:date];
}

@end

@implementation HVImmunization (HVDisplay)
