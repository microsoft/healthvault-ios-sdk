...
#import "HVProcedureFactory.h"

@implementation HVProcedure (HVFactoryMethods)
...
{
    return [HVProcedure createRandomForDay:date];
}

@end

@implementation HVProcedure (HVDisplay)
