...
@interface HVWeightTypeDataSource : HVSynchronizedTypeDataSource

@end

@interface HVViewController : HVUITaskAwareViewController
{
    HVSynchronizedType* m_type;
    HVSynchronizedTypeDataSource* m_dataSource;
    HVItemCommitScheduler* m_commitScheduler;
}
