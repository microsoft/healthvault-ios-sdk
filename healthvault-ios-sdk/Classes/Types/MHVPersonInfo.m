...
- (void)serialize:(XWriter *)writer
{
    ...
    [writer writeElement:c_element_settings content:self.applicationSettings];
...
- (void)deserialize:(XReader *)reader
{
    ...
    self.applicationSettings = [reader readElement:c_element_settings asClass:[MHVApplicationSettings class]];
